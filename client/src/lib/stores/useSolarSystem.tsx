...
                celestialObjectName: planetName, // FIX: Changed from 'planetName' to 'celestialObjectName'
                discoveryOrder: discoveryOrder,
                tokenReward: planet.tokenReward, // FIX: Changed from 'tokensEarned' to 'tokenReward'
              }),
            });
          } catch (error) {
